...
public class BehandelarenDetailOverzicht {
    ...
    public BehandelarenDetailOverzicht(Behandelaar behandelaar) {
        ...
        updateButton.setOnAction(actionEvent -> {
            ...
            /*
            String behandelaarscode, omschrijving;
            double prijs;

            //haal uit bestaand object
            behandelaarscode = behandelaar.getBsn();

            omschrijving = voorlettersField.getText();
            ...
            try {
                prijs = Double.parseDouble(achternaamField.getText());
            } catch (NumberFormatException e) {
            ...
            Behandelaar updated = new Behandelaar(behandelaarscode, prijs, omschrijving);
